-- Migration: 006_performance_and_supervisor_migration.sql
-- Purpose: Ensure the appuser/auth shape and performance appraisal tables exist with compatible indexes.

ALTER TABLE tbl_appusers
ADD COLUMN IF NOT EXISTS supervisor_id INT;
...
CREATE INDEX IF NOT EXISTS idx_appraisal_cycle_employees_evaluator ON appraisal_cycle_employees (main_evaluator_id);
