      ...
      <div className="cf-widget">
        <div className="cf-widget-header">
          <span className="cf-widget-title">
            <i className="bi bi-list-check" style={{ color: "#16a085" }}></i>My
            Actions
          </span>
          <i
            className="bi bi-gear"
            style={{ color: "#a0aec0", cursor: "pointer", fontSize: 15 }}
          ></i>
        </div>
        <div className="cf-widget-body">
          <div className="cf-action-item">
            <div
              className="cf-action-dot"
              style={{ background: "#16a085" }}
            ></div>
            <span style={{ fontSize: 13.5, color: "#2d3748" }}>
              (10) Leave Requests to Approve
            </span>
          </div>
          <div className="cf-action-item">
            <div
        ...
        <div className="cf-widget-body">
          <div className="cf-empty">
            <i
              ...
              style={{ color: "#16a085", opacity: 0.3 }}
            ></i>
