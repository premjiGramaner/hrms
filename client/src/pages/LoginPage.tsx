    ...
    <div className="flex min-h-screen font-sans">
      ...
      <div className="flex-0 w-1/2 bg-white flex flex-col items-center px-10 py-8 min-h-screen">
        ...
        <div className="w-full max-w-sm bg-white rounded-3xl shadow-md p-7 flex-1">
          ...
          {error && (
            <div className="bg-red-50 border-l-4 border-red-300 rounded px-3.5 py-2.5 text-red-900 text-sm mb-3.5">
              {error}
            </div>
          )}
          ...
          <p className="text-center text-sm text-slate-600 mb-3">
            Forgot Your{" "}
            <strong className="text-blue-900 cursor-pointer">Password?</strong>
          </p>
          <p className="text-center text-xs text-slate-400 mb-2.5">
            Or Login With
          </p>
          <div className="flex justify-center">
            <button className="w-10 h-10 rounded-full bg-teal-600 text-white border-none font-bold text-base cursor-pointer">
              L
            </button>
          </div>
        </div>
        ...
        <div className="mt-auto pt-6 text-center">
          ...
          <p className="text-xs text-slate-400 my-0.5">
          ...
          <div className="flex justify-center gap-2 mt-2">
            {["in", "f", "t", "yt"].map((n) => (
              <div
                key={n}
                className="w-7 h-7 rounded-full bg-slate-200 flex items-center justify-center text-xs text-slate-600 font-bold cursor-pointer"
              >
                {n}
              </div>
            ))}
