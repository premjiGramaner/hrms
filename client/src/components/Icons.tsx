...
export function IconClipboardList({ size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconUserCheck({ size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconPlusCircle({ size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconUserShield({ size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconFlask({ size = 16, color = strokecolor }: IconProps) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M9 3h6v7.5L20 21H4l5-10.5V3" />
      <path d="M7 3v4h10V3" />
    </svg>
  );
}
...
export function IconEyeOff({ size = 16, color = strokecolor }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconTwitterX({ size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconChevronLeft({ size = 16, color = strokecolor }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
